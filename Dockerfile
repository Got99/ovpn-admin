...
#ENV HTTP_PROXY="http://192.168.88.99:21087"
#ENV HTTPS_PROXY="https://192.168.88.99:21087"

RUN go install github.com/gobuffalo/packr/v2/packr2@latest
COPY --from=frontend-builder /app/static /app/frontend/static
COPY . /app
RUN cd /app && go mod tidy && go mod download && packr2 && env CGO_ENABLED=1 GOOS=linux GOARCH=amd64 go build -a -tags netgo -ldflags '-linkmode external -extldflags -static -s -w' -o ovpn-admin && packr2 clean
